...
public class Limit implements Serializable {
	...
	public static final Limit LIMIT_1 = buildLimit(1, 1);
	public static final Limit LIMIT_2 = buildLimit(1,2);
	private int size;
	private int pageId;
	private int start;
	 ...
	 * @return
	 */
	public static Object buildLimit(int currentPage) {
